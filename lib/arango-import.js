...
const filenames = {
  logs: [
    '2018-07-15.mailgun.log.json',
    '2018-07-16.mailgun.log.json',
    '2018-07-17.mailgun.log.json',
    '2018-07-18.mailgun.log.json',
    '2018-07-19.mailgun.log.json',
    '2018-07-20.mailgun.log.json',
    '2018-07-21.mailgun.log.json',
    '2018-07-22.mailgun.log.json',
    '2018-07-23.mailgun.log.json'
  ],
  companies: [ 'sample.json' ]
}
...
async function run() {
  ...
  try {
    ...
    await promiseSerial(filenames.logs.map(log => async () => {
      const filepath = path.resolve(path.join('company-data', log))
    ...
    await promiseSerial(filenames.companies.map(company => async () => {
      const filepath = path.resolve(path.join('company-data', company))
