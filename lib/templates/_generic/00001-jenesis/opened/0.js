...
module.exports = ({
  ...
  html: dedent`
    ...
    <br />
    <br />
    <a href="https://blog.nudj.co/case-study-ditto-sustainability/?utm_source=sales&utm_medium=email&utm_campaign=2207&utm_term=marcos">Ditto Sustainability</a> completely changed the way they hired once they started using nudj and you could to.
    <br />
    <br />
    To get started for free or to set up a demo head <a href="https://nudj.co/?utm_source=sales&utm_medium=email&utm_campaign=2207&utm_term=marcos&m=${hash}">here</a>.
    <br />
    <br />
    Best,
    <br />
