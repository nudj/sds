...
module.exports = ({
  ...
  html: dedent`
    ...
    <br />
    <br />
    Join 100s of other companies already using nudj to tap into hidden talent pools <a href="https://nudj.co/?utm_source=sales&utm_medium=email&utm_campaign=${campaign}&utm_term=marcos&m=${hash}">here</a> or let me know if you have any questions.
    <br />
    <br />
    Best,
    <br />
